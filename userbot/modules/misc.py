...
async def reedme(e):
    await e.edit(
        ...
        "\n[IzumiBot's README.md file](https://github.com/IzumiReina/IzumiBot/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit("Here is my [Repo](https://github.com/IzumiReina/IzumiBot)")
